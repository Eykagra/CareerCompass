...
export function IntakeForm({ onSubmit, loading, error }) {
  const [goal, setGoal] = useState("");
  const [stage, setStage] = useState("new_grad");
        ...
        <div className="grid gap-7 sm:grid-cols-2">
          ...
          <Field label="Target timeline">
            <Chips
              ...
              onChange={(v) => setTimelineMonths(v)}
              small
            />
          </Field>
        </div>
...
function Chips({ options, value, onChange, small }) {
  return (
